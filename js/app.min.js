...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateDropdownHeights(elems) {
    elems.forEach(function (elem) {
      var px = elem.scrollHeight;
      elem.style.setProperty('--dropdown-height', "".concat(px, "px"));
    });
  }
  ...
  // language
  var languageTrigger = document.querySelectorAll('.c-language__trigger');
  if (languageTrigger) {
    languageTrigger.forEach(function (item) {
  ...
  // mobile menu
  var mobileMenuTriggerDropdown = document.querySelectorAll('.mobile-menu__subtitle:not([href])');
  var mobileMenuDropdown = document.querySelectorAll('.mobile-menu__list');
  if (mobileMenuDropdown) {
    updateDropdownHeights(mobileMenuDropdown);
  }
  if (mobileMenuTriggerDropdown) {
    mobileMenuTriggerDropdown.forEach(function (item) {
      item.addEventListener('click', function (event) {
        event.preventDefault();
        var parent = item.closest('.mobile-menu__navs-item');
        if (parent.classList.contains('is--active')) {
          parent.classList.remove('is--active');
        } else {
          document.querySelectorAll('.mobile-menu__navs-item').forEach(function (item) {
  ...
  // programs card
  var programsCardTriggerDropdown = document.querySelectorAll('.programs-card__more');
  var programsCardDropdown = document.querySelectorAll('.programs-card__hidden');
  if (programsCardDropdown) {
    updateDropdownHeights(programsCardDropdown);
  }
  if (programsCardTriggerDropdown) {
    programsCardTriggerDropdown.forEach(function (item) {
      item.addEventListener('click', function (event) {
        event.preventDefault();
        var parent = item.closest('.programs-card');
        if (parent.classList.contains('is--active')) {
          parent.classList.remove('is--active');
        } else {
          document.querySelectorAll('.programs-card').forEach(function (item) {
            return item.classList.remove('is--active');
          });
          parent.classList.add('is--active');
        }
  ...
  // become member format
  var becomeMemberFormatItems = document.querySelectorAll('.become-member-format__item');
  var becomeMemberFormatTrigger = document.querySelectorAll('.become-member-format__package');
  if (becomeMemberFormatItems) {
    updateDropdownHeights(becomeMemberFormatItems);
  }
  if (becomeMemberFormatTrigger) {
    becomeMemberFormatTrigger.forEach(function (item) {
      item.addEventListener('click', function (event) {
        event.preventDefault();
        var parent = item.closest('.become-member-format__item');
  ...
  // become member stages accordeon
  var becomeMemberStagesTrigger = document.querySelectorAll('.become-member-stages__trigger');
  if (becomeMemberStagesTrigger) {
    becomeMemberStagesTrigger.forEach(function (item) {
      item.addEventListener('click', function (event) {
        event.preventDefault();
  ...
  // iframe loading
  var contentMediaIframe = document.querySelectorAll('.content-media__media');
  if (contentMediaIframe) {
    contentMediaIframe.forEach(function (item) {
      item.addEventListener('click', function (event) {
        event.preventDefault();
        if (!item.classList.contains('is--active')) {
          ...
          setTimeout(function () {
            item.querySelector('.content-media__loader').classList.add('is--hidden');
          }, 5000);
        }
      });
    });
  ...
  var contentGallerySlider = document.querySelectorAll('.content-gallery .swiper');
  if (contentGallerySlider) {
    contentGallerySlider.forEach(function (slider) {
      var myContentGallerySlider = new Swiper(slider, {
        slidesPerView: 1,
        loop: true,
        navigation: {
          prevEl: slider.closest('.content-gallery').querySelector('.swiper-button-prev'),
          nextEl: slider.closest('.content-gallery').querySelector('.swiper-button-next')
        },
        pagination: {
          el: slider.closest('.content-gallery').querySelector('.swiper-pagination'),
          clickable: true
        }
      });
    });
  ...
  window.addEventListener('resize', function () {
    if (document.querySelectorAll('.mobile-menu__list')) {
      updateDropdownHeights(document.querySelectorAll('.mobile-menu__list'));
    }
    if (document.querySelectorAll('.programs-card__hidden')) {
      updateDropdownHeights(document.querySelectorAll('.programs-card__hidden'));
    }
  });
